...
import edu.uci.ics.cloudberry.noah.adm.{MobileSignal, TaxiTrip}
import edu.uci.ics.cloudberry.util.Profile._

import scala.collection.mutable
import scala.io.Source

object hackJSONTagToADM {
  ...
  val usage =
    """
      ...
      |-f /path/to/csv/file
      |It will read csv file, geoTag borough/neighborhood information, and output an ADM file
    """.stripMargin
  ...
  def main(args: Array[String]): Unit = {
    ...
    MobileSignal.toADMFile(srcPath.toString, nyGeoGnosis)
