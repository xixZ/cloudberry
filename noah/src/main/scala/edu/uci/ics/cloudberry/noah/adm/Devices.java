...
public class Devices {
    ...
    public static Integer PARENT_DEVICE_ID_INDEX = 1;
    public static Integer COMPANY_ID_INDEX = 4;
    public static Integer DEVICE_UUID_INDEX = 5;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if(cols[PARENT_DEVICE_ID_INDEX].equals("NULL"))
                    ADM.keyValueToSbWithComma(sb, PARENT_DEVICE_ID, "null");
                else
                    ADM.keyValueToSbWithComma(sb, PARENT_DEVICE_ID, ADM.mkInt64Constructor(Long.parseLong(cols[PARENT_DEVICE_ID_INDEX])));
                ADM.keyValueToSbWithComma(sb, COMPANY_ID, ADM.mkInt32Constructor(cols[COMPANY_ID_INDEX]));
                ADM.keyValueToSbWithComma(sb, DEVICE_UUID, ADM.mkQuote(cols[DEVICE_UUID_INDEX]));
                ...
                ADM.keyValueToSbWithComma(sb, LANG, ADM.mkQuote(cols[LANG_INDEX]));
                sb.append("}\n");
